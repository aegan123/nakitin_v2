...
Hibernate is used to maintain the database schema and is able to update the database schema by itself pretty well, though there are things it cannot/won't do
